...
assertType('array<int|string, string|WP_Taxonomy>', get_attachment_taxonomies($type->int, $type::stringOr('names')));
assertType('array<int|string, string|WP_Taxonomy>', get_attachment_taxonomies($type->int, $type::stringOr('objects')));
